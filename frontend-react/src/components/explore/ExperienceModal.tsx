...
import { experienceApi } from '../../services/api.ts';
  ...
  return (
    <div className="p-6 bg-white rounded-xl shadow-lg w-full max-w-md border border-slate-100">
      ...
      <div className="flex items-center gap-2">
        <button
          onClick={handleLike}
          className={`p-2 rounded-full transition-all duration-300 transform active:scale-90 ${isLiked ? 'bg-red-50 text-red-500' : 'bg-gray-50 text-gray-500 hover:bg-gray-100'
            }`}
        >
